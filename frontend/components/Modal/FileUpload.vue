      ...
      <UCard>
        <template #header>
          <div class="flex items-center justify-between">
            <h3 class="text-lg font-semibold text-slate-200 cursor-default">
              Upload Files
            </h3>
            <p class="text-sm text-slate-400 cursor-default">
            ...
            >
              <div class="flex items-center space-x-3">
                ...
                <div class="flex-1">
                  ...
                  <p class="text-xs text-slate-400 cursor-default">
                    {{ formatFileSize(file.size) }}
                  </p>
                  <p
                    v-if="isFileRejected(file.name)"
              ...
              <div class="flex items-center gap-2">
                ...
                <UButton
                  v-if="!isUploading && rejectedFileStatus.length === 0"
                  color="error"
                  variant="ghost"
