            ...
            <UCard>
                ...
                <template #footer>
                    <div class="flex justify-between">
                        <div>
                            <UButton color="warning" variant="solid" icon="i-heroicons-arrow-path"
                                @click="emit('reprocess', props.file)">
                                Reingest
                            </UButton>
                        </div>
                        <div class="flex gap-2">
                            <UButton color="neutral" variant="ghost" class="text-white" icon="i-heroicons-eye"
                                @click="emit('view', props.file)">
                                View
                            </UButton>
                            <UButton color="error" variant="solid" icon="i-heroicons-trash"
